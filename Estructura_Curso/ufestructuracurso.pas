...
begin
  ...
  agregarCapitulo('¿Qué es un TStringGrid?');
  agregarCapitulo('¿Qué es un TSaveDialog?');
  agregarCapitulo('Guardar la tabla');
  agregarCapitulo('¿Qué es un TOpenDialog?');
  agregarCapitulo('Leer la tabla');
  agregarCapitulo('¿Qué es un archivo INI?');
  agregarCapitulo('Guardar configuraciones en INI');
  agregarCapitulo('Leer configuraciones desde INI');
  agregarCapitulo('Exportar a INI');
  agregarCapitulo('Importar desde INI');
  agregarCapitulo('¿Qué es un archivo CSV?');
